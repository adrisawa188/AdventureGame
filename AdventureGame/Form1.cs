        ...
        public void DisplayPage()
        {
            switch (page)
            {
                case 1:
                    ...
                    option1Button.Text = "Do you want to spen the night";
                    option2Button.Text = "Do you want to go back";
                ...
                case 3:
                    ...
                    option1Button.Text = "Set up camp";
                ...
                case 4:
                    ...
                    option1Button.Text = "Lookj for food";
                    option2Button.Text = "Try to find path";
                    option3Button.Enabled = true;
                    option3Button.Text = "Build fire";
                    break;
                case 5:
                    outputLabel.Text = "You come accross some berries, they look familiar and you don't think they are poisonous";

                    option1Button.Text = "Eat them";
                    option2Button.Text = "Do not";
                    option3Button.Enabled = false;
                    break;
                case 6:
                    outputLabel.Text = "You rummage around collecting sticks and manage to start a fire";

                    option1Button.Text = "Sit around the fire";
                    option2Button.Text = "Try to find the path";
                    option3Button.Enabled = false;
                    break;
                case 7:
                    outputLabel.Text = "You feel replenished";

                    option1Button.Text = "Find path";
                    option2Button.Text = "Go back to camp";
                    option3Button.Enabled = false;
                    break;
                case 8:
                    outputLabel.Text = "You decide it is too dangerous to eat them";

                    option1Button.Text = "Try to find more food";
                    option2Button.Text = "Go back to camp";
                    option3Button.Enabled = false;
                    break;
                case 9:
                    ...
                    option1Button.Text = "Go north";
                    option2Button.Text = "Go south";
                    option3Button.Enabled = false;
                    break;
                case 10:
                ...
                case 11:
                    ...
                    option1Button.Text = "Keep looking";
                    option2Button.Text = "Head back";
                    option3Button.Enabled = false;
                    break;
                case 12:
                ...
                case 14:
                    ...
                    option1Button.Text = "Build fire";
                    option2Button.Text = "Got to sleep";
                    option3Button.Enabled = false;
                    break;
                case 15:
                ...
                case 17:
                    ...
                    option1Button.Text = "Try to find camp";
                ...
                case 19:
                    ...
                    option1Button.Text = "Build a fire";
                    option2Button.Text = "Go to sleep";
                    option3Button.Enabled = false;
                    break;
                case 20:
                ...
                case 23:
                    ...
                    option1Button.Text = "Investigate";
                    option2Button.Text = "Go back to camp";
                    option3Button.Enabled = false;
                    break;
                case 24:
